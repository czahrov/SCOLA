...
<body>
	...
	<div class="grid padding">
		<div class="page-position">Obecnie przeglądasz: <a href="<?php echo home_url(''); ?>">Strona główna</a><span>o</span><a href="<?php echo home_url('kursy'); ?>">Języki</a><span>o</span><a href="<?php echo home_url('hiszpanski'); ?>">Język Hiszpański</a></div>
	</div>
	<!-- LANGUAGE HEADEAR -->
	<div class="language-header">
		<div class="grid padding flex flex-column flex-row-ml">
			<div class="language-wrapper flex flex-column base2-ml">
				<div class="language-title">Kurs języka hiszpańskiego w <span class="dark-green">Scola</span></div>
				...
				<div class="language-buttons flex flex-column flex-row-ds flex-items-start flex-justify-between-ds">
					...
					<a href="http://www.scola.pl/media/File/scola_test_hiszpanski.pdf" class="confirm-btn confirm-btn-green flex no-border">
				...
				<div class="levels">Ilość poziomów zaawansowania:<div class="level-count">5</div></div>
			...
			<div class="language-poster" style="background-image: url(<?php echo get_template_directory_uri(); ?>/img/poster_hisz.jpg);"></div>
		</div>
	</div>
		...
		<div class="grid padding">
			...
			<div class="add-text-box flex flex-items-center">
				...
				<div class="add-text-bar">
					<div class="add-text-line1">W SCOLA istnieje możliwość zapisania się na kurs z języka hiszpańskiego do grup liczących:</div>
			...
			<ul class="add-list">
				...
				<li>nauka języka hiszpańskiego w biznesie</li>
				<li>szybki kurs dla osób wyjeżdzających za granicę.</li>
			</ul>
			<div class="add-end">Każdy z kursantów otrzymuje w cenie kursu materiały dydaktyczne niezbędne do nauki języka hiszpańskiego</div>
		</div>
	</div>
